...
class Potion(Item):
    ...
    def apply_weapon_boost(self, inventory) -> None:
...
def annotation_function() -> int:
    return int

def doctype_function():
...
class lower:
    ...
    def this_should_adhere(self):
        '''should adhere to lower_case_test'''
        pass
    
    def _is_snake_case(self):
        '''this should be snake case'''
        pass

def _per_assignment_1_snake(self):
    '''this should be snake case'''
    pass
